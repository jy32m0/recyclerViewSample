...
class RecyclerAdapter: RecyclerView.Adapter<RecyclerAdapter.ViewHolder>() {
    ...
    private var images = intArrayOf(R.drawable.uspslogo, R.drawable.uspslogo, R.drawable.uspslogo,
        R.drawable.uspslogo, R.drawable.uspslogo, R.drawable.uspslogo, R.drawable.uspslogo, R.drawable.uspslogo)
    ...
    inner class ViewHolder(itemView: View): RecyclerView.ViewHolder(itemView) {
        ...
        init {
            ...
            itemView.setOnClickListener {
                ...
                Toast.makeText(itemView.context, "You have clicked ${titles[position]}", Toast.LENGTH_LONG).show()
            }
        }
    }
}